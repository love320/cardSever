...
public class CharTools {
	...
	public static void main(String[] args) {
		...
		String url;
		System.out.println(charTools.ISO2GB("%B7%BD%D5%FD%BA%DA%CC%E5%BC%F2%CC%E5"));
		try {
			System.out.println(URLDecoder.decode("%B7%BD%D5%FD%BA%DA%CC%E5%BC%F2%CC%E5","gb2312"));
